<template>
  <div class="board">
    ...
    <div class="list">
      <div class="header" v-bind:style="{ backgroundColor: 'item' }">
    ...
    <div class="add_cat" >
    <form>
    <p><input type="text" id="name_cat" v-model="formCat.name" placeholder="Categorie..."></p>
    </form>
    <button v-on:click="createCat()" class="addBtn">Ajouter une autre catégorie &plus;</button> <br>
    <ColorChange :item='item'></ColorChange>
    </div>
  </div>
</template>
